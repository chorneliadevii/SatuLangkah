...
<html>
    <head>
        ...
        <title>Produk Lokal Admin Satu Langkah</title>
    ...
    <body>
        ...
        <div class="destinasi">
            ...
            <c:forEach items="${daftarProdukAdmin.daftar}" var="dp">
                <div class="shadow">
                    <form action="./verifikasiDataProduk" >
                        <table>
                            <tr>
                                <td>  
                                    <h3>${dp.namaBarang}</h3>
                                ...
                                <td>
                                    <div>
                                        <h4>Id Produk</h4>
                                        <input type="text" name="idProduk" readonly="id" value="${dp.idProdukLokal}">
                                    </div>
                                    <div>
                                        <h4>Harga Jual</h4>
                                        <input type="number" name="harga" readonly="harga" value="${dp.harga}">
                                    </div>
                                    <div>
                                        <h4>Keterangan</h4>
                                    ...
                                    <div>
                                        <h4>Kuantitas</h4>
                                        <input type="text" name="stok" readonly="stok" value="${dp.kuantitas}">
                                    </div>
                                </td>
                                <td>
                                    <div class="kanan">
